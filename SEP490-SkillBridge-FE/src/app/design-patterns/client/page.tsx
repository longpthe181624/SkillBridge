...
export default function ClientDesignPattern() {
  const engineers = [
    { id: '1', name: 'John Doe', title: 'Senior React Developer', skills: ['React', 'TypeScript', 'Node.js'], experience: '5 years', location: 'Tokyo, Japan' },
    { id: '2', name: 'Jane Smith', title: 'Angular Specialist', skills: ['Angular', 'RxJS', 'Material UI'], experience: '7 years', location: 'Ho Chi Minh, Vietnam' },
    { id: '3', name: 'Peter Jones', title: 'Vue.js Expert', skills: ['Vue.js', 'Nuxt.js', 'Vuetify'], experience: '3 years', location: 'Osaka, Japan' },
  ];
      ...
      <main className="container mx-auto px-4 py-8 space-y-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ClientStatsCard title="Total Engineers" value="1,200" change="+10% from last month" changeType="positive" />
            <ClientStatsCard title="Available Projects" value="50" change="-5% from last month" changeType="negative" />
            <ClientStatsCard title="Happy Clients" value="800+" change="+15% from last month" changeType="positive" />
          </div>
        </section>
                  ...
                  <TableBody>
                    {engineers.map((engineer) => (
                      <TableRow key={engineer.id}>
                        ...
                        <TableCell>{engineer.skill}</TableCell>
