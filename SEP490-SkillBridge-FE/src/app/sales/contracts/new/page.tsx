...
function CreateMSAPageContent() {
    ...
    const handleSOWSubmit = async (action: 'save' | 'draft') => {
        ...
        try {
            ...
            const dataToSubmit = {
                ...sowFormData,
                status: action === 'draft' ? 'Draft' : sowFormData.status,
            };
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    min={minDateStr}
                                                    max={maxDateStr}
                                                    className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${msaValidationErrors.effectiveStart ? 'border-red-500' : ''}`}
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                max={maxDateStr}
                                                className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${msaValidationErrors.effectiveEnd ? 'border-red-500' : ''}`}
                                                lang={language === 'ja' ? 'ja-JP' : 'en-US'}
                                            />
                                                <button
                                                    type="button"
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value="Client Under Review">Client Under Review</SelectItem>
                                ...
                                <section className="border-b pb-6">
                                    ...
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                                        ...
                                        >
                                            ...
                                            <span className="text-gray-600">{t('sales.createMsa.attachments.upload')}</span>
                                        </label>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    onChange={(e) => {
                                                        setSowFormData(prev => ({ ...prev, effectiveStart: e.target.value }));
                                                    }}
                                                    min={minDateStr}
                                                    max={maxDateStr}
                                                    className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${sowValidationErrors.effectiveStart ? 'border-red-500' : ''}`}
                                                    lang={language === 'ja' ? 'ja-JP' : 'en-US'}
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        const input = document.getElementById('sow-effectiveStart') as HTMLInputElement;
                                                        if (input && 'showPicker' in input) {
                                                            input.showPicker();
                                                        }
                                                    }}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <Input
                                                    ...
                                                    max={maxDateStr}
                                                    className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${sowValidationErrors.effectiveEnd ? 'border-red-500' : ''}`}
                                                    lang={language === 'ja' ? 'ja-JP' : 'en-US'}
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => {
                                                        const input = document.getElementById('sow-effectiveEnd') as HTMLInputElement;
                                                        if (input && 'showPicker' in input) {
                                                            input.showPicker();
                                                        }
                                                    }}
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => {
                                                    setSowFormData(prev => ({ ...prev, projectName: e.target.value }));
                                                }}
                                        ...
                                        <div>
                                            ...
                                            <Select
                                                value={sowFormData.status}
                                                onValueChange={(value) => {
                                                    setSowFormData(prev => ({ ...prev, status: value }));
                                                }}
                                            >
                                                <SelectTrigger>
                                                    <SelectValue />
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="relative">
                                                                    <Input
                                                                        ...
                                                                        min={minDateStr}
                                                                        max={maxDateStr}
                                                                        className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${sowValidationErrors[`engineerStartDate_${index}`] ? 'border-red-500' : ''}`}
                                                                        lang={language === 'ja' ? 'ja-JP' : 'en-US'}
                                                                    />
                                                                    <button
                                                                        type="button"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="relative">
                                                                    <Input
                                                                        ...
                                                                        max={maxDateStr}
                                                                        className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${sowValidationErrors[`engineerEndDate_${index}`] ? 'border-red-500' : ''}`}
                                                                        lang={language === 'ja' ? 'ja-JP' : 'en-US'}
                                                                    />
                                                                    <button
                                                                        type="button"
                                                        ...
                                                        <td className="border border-gray-300 p-2">
                                                            <div className="relative">
                                                                <Input
                                                                    ...
                                                                    onChange={(e) => updateMilestoneDeliverable(index, 'plannedEnd', e.target.value)}
                                                                ...
                                                                <td className="border border-gray-300 p-2">
                                                                    <div className="relative">
                                                                        <Input
                                                                            ...
                                                                            className={`pr-10 [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-calendar-picker-indicator]:appearance-none ${sowValidationErrors[`billingPaymentDate_${index}`] ? 'border-red-500' : ''}`}
                                                                            lang={language === 'ja' ? 'ja-JP' : 'en-US'}
                                                                        />
                                                                        <button
                                                                            type="button"
                                ...
                                <section className="border-b pb-6">
                                    ...
                                    >
                                        ...
                                        <label htmlFor="sow-file-upload" className="cursor-pointer">
                                            ...
                                            <p className="text-gray-600">Click or Drag & Drop PDF here</p>
                                        </label>
                                    </div>
