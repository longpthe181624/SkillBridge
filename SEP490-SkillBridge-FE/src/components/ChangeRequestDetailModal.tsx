...
export default function ChangeRequestDetailModal({
    ...
    const fetchChangeRequestDetail = async () => {
        try {
            ...
            setError(err.message || 'Failed to fetch change request detail');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            alert(err.message || t('client.contractDetail.changeRequestDetail.error.updateFailed'));
        } finally {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            alert(err.message || t('client.contractDetail.changeRequestDetail.error.submitFailed'));
        } finally {
            setActionLoading(false);
        }
    };
    ...
    const isUnderReview = changeRequest.status === 'Under Review';
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <Badge variant={getStatusBadgeVariant(changeRequest.status) as any}>
