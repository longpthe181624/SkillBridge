...
export default function CommentModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (message.length > maxLength) {
      setError(t('client.contactDetail.comment.messageTooLong') || `Message must not exceed ${maxLength} characters`);
      return;
    }
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : t('client.contactDetail.comment.submitFailed'));
    } finally {
      setLoading(false);
    }
  };
