-- V18__seed_contracts_msa_sow_separated.sql
-- Seed contract data (MSA and SOW separated) for user id = 2
...
SET @msa_contract_id_1 = LAST_INSERT_ID();
...
VALUES
    (@msa_contract_id_1, DATE_SUB(NOW(), INTERVAL 365 DAY), 'MSA contract created and sent to client', @client_user_id, 'MSA', DATE_SUB(NOW(), INTERVAL 365 DAY)),
    (@msa_contract_id_1, DATE_SUB(NOW(), INTERVAL 360 DAY), 'MSA contract approved by client', @client_user_id, 'MSA', DATE_SUB(NOW(), INTERVAL 360 DAY)),
    (@msa_contract_id_1, DATE_SUB(NOW(), INTERVAL 180 DAY), 'MSA contract renewed for another year', @client_user_id, 'MSA', DATE_SUB(NOW(), INTERVAL 180 DAY));

-- ============================================
-- 2. MSA Contract 2 (Draft)
-- ============================================
INSERT INTO contracts (
    client_id,
    contract_name,
...
SET @msa_contract_id_2 = LAST_INSERT_ID();

-- Add draft MSA history
INSERT INTO contract_history (contract_id, entry_date, description, created_by, history_type, created_at)
VALUES
    (@msa_contract_id_2, DATE_SUB(NOW(), INTERVAL 7 DAY), 'Draft MSA contract created for review', @client_user_id, 'MSA', DATE_SUB(NOW(), INTERVAL 7 DAY));

-- ============================================
-- 3. SOW Fixed Price Contract
-- ============================================
...
INSERT INTO contract_history (contract_id, sow_contract_id, entry_date, description, created_by, history_type, created_at)
VALUES
    (NULL, @sow_fixed_price_id, DATE_SUB(NOW(), INTERVAL 180 DAY), 'SOW Fixed Price contract created', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 180 DAY)),
    (NULL, @sow_fixed_price_id, DATE_SUB(NOW(), INTERVAL 175 DAY), 'SOW contract approved by client', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 175 DAY)),
    (NULL, @sow_fixed_price_id, DATE_SUB(NOW(), INTERVAL 150 DAY), 'Design Phase milestone completed and invoiced', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 150 DAY)),
    (NULL, @sow_fixed_price_id, DATE_SUB(NOW(), INTERVAL 60 DAY), 'Development Phase 1 milestone completed and invoiced', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 60 DAY));
...
INSERT INTO contract_history (contract_id, sow_contract_id, entry_date, description, created_by, history_type, created_at)
VALUES
    (NULL, @sow_retainer_id, DATE_SUB(NOW(), INTERVAL 90 DAY), 'SOW Retainer contract created', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 90 DAY)),
    (NULL, @sow_retainer_id, DATE_SUB(NOW(), INTERVAL 85 DAY), 'SOW Retainer contract approved by client', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 85 DAY)),
    (NULL, @sow_retainer_id, DATE_SUB(NOW(), INTERVAL 60 DAY), 'November 2024 delivery completed and invoiced', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 60 DAY)),
    (NULL, @sow_retainer_id, DATE_SUB(NOW(), INTERVAL 30 DAY), 'December 2024 delivery completed and invoiced', @client_user_id, 'SOW', DATE_SUB(NOW(), INTERVAL 30 DAY));
