...
class ClientContractControllerTest {
    ...
    @Test
    @DisplayName("getContracts - success with authenticated user")
    void testGetContracts_Success() {
        ...
        ResponseEntity<?> response = controller.getContracts(
                "q", "ACTIVE", "MSA", 1, 20, authentication, httpServletRequest
        );

        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertSame(res, response.getBody());
        verify(contractListService).getContracts(1, "q", "ACTIVE", "MSA", 1, 20);
    }
    ...
    void testGetContractDetail_NotFound() {
        ...
        ResponseEntity<?> response = controller.getContractDetail(10, authentication, httpServletRequest);
    ...
    void testGetVersions_NotFound() {
        ...
        ResponseEntity<?> response = controller.getSOWContractVersions(10, authentication, httpServletRequest);
    ...
    void testApproveContract_NotFound() {
        ...
        ResponseEntity<?> response = controller.approveContract(10, authentication, httpServletRequest);
    ...
    void testApproveContract_Success() {
        when(authentication.isAuthenticated()).thenReturn(true);
        when(authentication.getPrincipal()).thenReturn("3");
        ...
        verify(contractDetailService).approveContract(10, 3);
    }
    ...
    void testAddComment_MissingComment() {
        ...
        ResponseEntity<?> response = controller.addComment(10, req, authentication, httpServletRequest);
    ...
    void testCancelContract_Success() {
        ...
        ResponseEntity<?> response = controller.cancelContract(10, req, authentication, httpServletRequest);
